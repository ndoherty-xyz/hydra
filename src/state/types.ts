...
export type AppMode = "normal" | "creating-session" | "confirming-close" | "workspace-creating" | "git-select" | "git-message" | "git-running" | "git-result" | "sync-running" | "sync-result";
